...
# with open("streamlit/src/style_pages.css") as f:
...
with c1:
    #info_antes = Image.open(r'streamlit/src/antes_sismos.jpg')
    ...
    st.image(info_antes, caption='¿Qué hacer antes de un sismo? (imagen)', width=1000)

    with st.expander('Abrir para más información'):
...
with c2:
    ...
    #info_durante = Image.open(r'streamlit/src/durante_sismos.jpg')
    ...
    st.image(info_durante, caption='¿Qué hacer durante de un sismo? (imagen)', width=1000) 
...
with c3:
    #info_despues = Image.open(r'streamlit/src/despues_sismos.jpg')
    ...
    st.image(info_despues, caption='¿Qué hacer después de un sismo? (imagen)', width=1000)
